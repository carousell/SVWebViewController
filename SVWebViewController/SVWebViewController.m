...
- (void)updateToolbarItems {
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
        ...
        toolbar.items = items;
        toolbar.barStyle = self.barStyle ? self.barStyle : self.navigationController.navigationBar.barStyle;
        ...
        self.navigationController.toolbar.barStyle = self.barStyle ? self.barStyle : self.navigationController.navigationBar.barStyle;
...
- (void)webViewDidFinishLoad:(UIWebView *)webView {
    ...
    self.navigationItem.title = self.title ? self.title : [webView stringByEvaluatingJavaScriptFromString:@"document.title"];
    [self updateToolbarItems];
}
